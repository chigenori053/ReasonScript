...
Current release: **v0.5.4.2**. See [`CHANGELOG.md`](CHANGELOG.md) for the
detailed history and [`docs/roadmap.md`](docs/roadmap.md) for what's next.
Use
[`docs/installation/ReasonScript_v0_5_4_2_Installation.md`](docs/installation/ReasonScript_v0_5_4_2_Installation.md)
