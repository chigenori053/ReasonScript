...
Current release: **v0.5.6.1** (language core `0.7`).

## Install

The prebuilt V0.5.6.1 package supports macOS arm64. Download the ZIP and its
SHA-256 sidecar from the [V0.5.6.1 GitHub Release](https://github.com/chigenori053/ReasonScript/releases/tag/v0.5.6.1), verify it, and install or update it with:

```sh
shasum -a 256 -c reasonscript-0.5.6.1-macos-arm64.zip.sha256
reason update --package reasonscript-0.5.6.1-macos-arm64.zip
```
