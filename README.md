...
Current release: **v0.5.2.4**. See [`CHANGELOG.md`](CHANGELOG.md) for the
detailed history and [`docs/roadmap.md`](docs/roadmap.md) for what's next.
Use
[`docs/installation/ReasonScript_v0_5_2_4_Installation.md`](docs/installation/ReasonScript_v0_5_2_4_Installation.md)
